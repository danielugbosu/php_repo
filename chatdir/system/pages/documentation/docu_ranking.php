<div class="page_full">
	<div class="page_element item_page_title">
		<p class="bold"><i class="fa fa-star"></i> Ranking system</p>
	</div>
</div>
<div class="page_element">
	<div class="docu_box">
		<div class="docu_head border_bottom sub_list">
			<i class="fa fa-paw ico_new"></i> Guest
		</div>
	...
	<div class="docu_box">
		<div class="docu_head border_bottom sub_list">
			<i class="fa fa-user ico_user"></i> User
		</div>
		<div class="docu_content">
			<div class="docu_option_description sub_text">
				<ul class="docu_sub_list">
	...
	<div class="docu_box">
		<div class="docu_head border_bottom sub_list">
			<i class="fa fa-legal ico_radmin"></i> Room admin
		</div>
		<div class="docu_content">
			<div class="docu_option_description sub_text">
				<ul class="docu_sub_list">
	...
	<div class="docu_box">
		<div class="docu_head border_bottom sub_list">
			<i class="fa fa-legal ico_rmod"></i> Room moderator
		</div>
		<div class="docu_content">
			<div class="docu_option_description sub_text">
				<ul class="docu_sub_list">
