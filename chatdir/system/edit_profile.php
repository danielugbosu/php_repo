...
<div class="modal_zone  pad_box hide_zone" id="personal_about">
	<div class="form_split">
		<div class="chat_settings ">
			<p class="label"><?php echo $lang['user_chatstatus']; ?></p>
			<textarea id="set_user_chatstatus" class="large_textarea about_area full_textarea" spellcheck="false" maxlength="800" ><?php echo $data['user_chatstatus']; ?></textarea>
		</div>
	</div>
	<button type="button" onclick="saveChatstatus()"id="save_chatstatus" class="reg_button theme_btn"><i class="fa fa-floppy-o"></i> <?php echo $lang['save']; ?></button>
</div>
<?php if(guestCanRegister()){ ?>
