...
<div class="pad_box">
    ...
    <div class="color_choices" data="<?php echo $data['bccolor']; ?>">
        <?php echo colorChoicetext($data['bccolor'], 2); ?>
    </div>
    <div class="clear"></div>
                    <?php if(boomAllow(9)){ ?>
                        <p class="label"><?php echo $lang['text_coloradmin']; ?></p>
        <div class="color_choices" data="<?php echo $data['bccolor']; ?>">
        <?php echo colorChoiceadmin($data['bccolor'], 2); ?>
            <div class="clear"></div>
                                    <p class="label"><?php echo $lang['text_bold']; ?></p>
            <button id="boldit" data="<?php echo $data['bcbold']; ?>" class="set_button <?php echo boldIt($data['bcbold']); ?>"><?php echo $lang['bold']; ?></button>
    </div>
        <?php } ?>
    <div class="clear"></div>
<button id="boldit" data="<?php echo $data['bcbold']; ?>" class=" <?php echo boldIt($data['bcbold']); ?></button>
    <?php } ?>
