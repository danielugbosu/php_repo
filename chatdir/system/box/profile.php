...
<p class="list_element info_pro"><span class="bold"><?php echo $lang['chat_triviascore']; ?> : </span> <i title="Quizscore" class="ico_vip fa fa-trophy"></i> <?php echo ($user['quiz_score']); ?></p>		
		
		<?php if(boomAllow(9) && !isBot($user['user_bot'])){ ?>
			...
			<p class="list_element info_pro"><span class="bold"><?php echo $lang['id']; ?> :</span> <?php echo $user['user_id']; ?></p>
