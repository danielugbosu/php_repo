...
<link id="actual_theme" rel="stylesheet" type="text/css" href="css/themes/<?php echo getTheme(); ?>" />
<link rel="stylesheet" type="text/css" href="css/responsive.css" />
<script data-cfasync="false" type="text/javascript" src="js/jquery-1.11.2.min.js"></script>
<script data-cfasync="false" type="text/javascript" src="system/language/<?php echo $cur_lang; ?>/language.js"></script>
...
<script data-cfasync="false" type="text/javascript" src="js/global.min.js"></script>
<script data-cfasync="false" type="text/javascript" src="js/split.js"></script>
<?php if(boomRecaptcha() && !boomLogged()){ ?>
<script src='https://google.com/recaptcha/api.js'></script>
<?php } ?>
<?php if(boomLogged()){ ?>
<script data-cfasync="false" type="text/javascript" src="js/split_logged.js"></script>
<?php } ?>
<?php if($brtl == 1){ ?>
