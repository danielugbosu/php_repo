<div id="chat_head" class="chat_head">
	...
	<div class="mobile_logo">
		<img alt="logo" src="<?php echo getLogo ('mobile_logo'); ?>"/>
	</div>
	<div class="head_logo">
		<img alt="logo" src="<?php echo getLogo ('logo'); ?>"/>
	</div>
	<?php } ?>
	<div id="empty_top_mob">
	</div>
		  				<div onclick="openPlayer();" class="chat_header_item">
					<i class="i_btm fa fa-music"></i>
				</div>
				<div onclick="getRoomList();" class="chat_header_item">
					<i class="i_btm fa fa-home"></i>
				</div>
				<div title="<?php echo $lang['user_list']; ?>" onclick="userReload(1);" class="chat_header_item">
					<i class="i_btm fa fa-users"></i>
				</div>
	<div title="<?php echo $lang['private_list']; ?>" value="0" onclick="getPrivate();" id="get_private" class="chat_header_item">
		<i class="i_btm fa fa-envelope"></i>
		<div id="notify_private" class="notification faa-shake animated""></div>
	</div>
				...
				<div id="more_menu_list" class="sub_menu_in">
					<div id="chat_help_menu" class="left_item elem_in more_left" onclick="showHelp();">
						<div class="left_item_in">
							...
							<?php if(boomAllow(10)){ ?>
						<div id="chat_help_menu1"class="list_element left_item getbox" data-size="500" data-box="system/panel/history.php" data-type="panel">
				<div class="left_item_in">
				      
					<span class="boom_menu_icon"><i class="fa fa-history menui"></i></span> Zoeken
				</div>
			</div>	
				<?php } ?>			
							...
							<form id="main_input" name="chat_data" action="" method="post">
								<div class="input_table">
									...
									<div id="main_input_box" class="td_input">
										<input type="text" spellcheck="false" name="content" " placeholder="<?php echo $lang['typ']; ?>" maxlength="<?php echo $data['max_main']; ?>" id="content" autocomplete="off"/>
									</div>
									<?php if( canUpload()){ ?>
									<div class="input_item main_item" id="send_image"><i id="chat_file_icon" data="fa-camera" class="fa fa-camera"></i>
										<input id="chat_file" onchange="uploadChat();" type="file"/>
									</div>
									<?php } ?>	
									<div id="inputt_right" class="main_item">
										<button type="submit"  class="default_btn" id="submit_button"><i  class="fa fa-arrow-circle-right fa-lg"></i></button>
									</div>
								</div>
							</form>
						</div>
		...
		<form id="message_form"  action="" method="post" name="private_form">
			<div class="input_table">
				...
				<div id="private_input_box" class="td_input">
					<input spellcheck="false" id="message_content"" placeholder="<?php echo $lang['typ']; ?>" maxlength="<?php echo $data['max_private']; ?>" data-target=""  autocomplete="off"/>
				</div>
				<?php if( canUpload()){ ?>
				<div class="input_item main_item"><i id="private_file_icon" data="fa-camera" class="fa fa-camera"></i>
					<input id="private_file" onchange="uploadPrivate();" type="file"/>
				</div>
				<?php } ?>
				<div id="message_send" class="main_item">
					<button class="default_btn" id="private_send"><i class="fa fa-arrow-circle-right fa-lg"></i></button>
				</div>
			</div>
		</form>
...
<div id="wrap_footer" data="1" >
	<div class="chat_footer" id="menu_container">
		<div id="menu_container_inside">
			<div id="my_menu">
				...
				<div class="chat_footer_empty">
				</div>
	<div onclick="getNotification();" class="chat_footer_item">
		...
		<div id="notify_notify" class="notification bnotify"></div>
				...
				<?php } ?>
					<?php if(boomAllow(1)){ ?>
	<div onclick="friendRequest();" class="chat_footer_item">
	...
	<?php if(boomAllow(8)){ ?>
	<div onclick="loadReport();" class="chat_footer_item">
...
<?php loadAddonsJs();?>
<script data-cfasync="false" type="text/javascript" src="js/function.js"></script>
<script data-cfasync="false" type="text/javascript" src="js/player.js"></script>