...
<audio class="hidden" id="private_sound" src="<?php echo $data['domain']; ?>/sounds/private.mp3"></audio>
<audio class="hidden" id="message_sound" src="<?php echo $data['domain']; ?>/sounds/new_messages.mp3"></audio>
<audio class="hidden" id="username_sound" src="<?php echo $data['domain']; ?>/sounds/username.mp3"></audio>
<audio class="hidden" id="whistle_sound" src="<?php echo $data['domain']; ?>/sounds/whistle.mp3"></audio>
<audio class="hidden" id="notify_sound" src="<?php echo $data['domain']; ?>/sounds/notify.mp3"></audio>
<audio class="hidden" id="news_sound" src="<?php echo $data['domain']; ?>/sounds/new_news.mp3"></audio>