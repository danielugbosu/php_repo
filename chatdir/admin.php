...
if(isOwner()){
	...
	if(boomAllow(11)){
	$side_menu .= pageMenu('admin/messagelog.php', 'envelope-o', $lang['chat_logs']);
	$side_menu .= pageMenu('admin/picture.php', 'camera', $lang['picture_logs']);
}
if(boomAllow(10)){
		$side_menu .= pageMenu('admin/chatlogs.php', 'camera', $lang['chat_logs']);
